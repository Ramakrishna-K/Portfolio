...
import profileImage from '../../assets/picprofile1.png';
    ...
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          {/* Greeting */}
          <h1 className="text-3xl sm:text-4xl md:text-3xl font-bold text-white mb-2 leading-tight">
            Hi, I am
          </h1>
          {/* Name */}
          <h2 className="text-4xl sm:text-4xl md:text-4xl font-bold text-white mb-4 leading-tight">
            Ramakrishna Katravath
          </h2>
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/12LMErrRmKk7KvLtZZmRZWc3dbL2pYhP4/view"
            target="_blank"
